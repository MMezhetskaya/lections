...
2. Переведите структуру CSS на SASS. 
3. Через media query добавте мобильную верстку (screen < 768)
4. Сделайте mixin для media query
5. Обновите основной gulp так что бы css на выходе была сжата и оптимизированна
