...
Создать компонент, который будет доступен по адресу: **[localhost:3000/list](http://localhost:3000/list)**
...
- после логина редирект на  **/admin** если  **admin**, в противном случае на главную **/**
...
- во время логина мы сделаем задержку

    - когда пришел ответ

        - перенаправим браузер пользователя на **/admin**

            - роутинг посредством **store.dispatch**
