...
- **DIV**
    ...
    - неуклюжие и ужасно загружают производительность в больших количествах
...
- **SVG** лучше для
    ...
    - приложений с небольшим количеством элементов (менее 1000? зависит действительно)

- **DIV**

    - неуклюжие и не масштабируются

    - делая круг возможно только с закругленными углами

    - сложные формы возможными, но включает в себя сотни крошечных крошечных пиксельных разделов
